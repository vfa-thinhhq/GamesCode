//
//  ViewAnimationDemoAppDelegate.h
//  ViewAnimationDemo
//
...
@class ViewAnimationDemoViewController;

@interface ViewAnimationDemoAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    ViewAnimationDemoViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet ViewAnimationDemoViewController *viewController;
